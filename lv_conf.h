...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (40 * 1024U)          /**< [bytes] - Reduced to 40KB to allow larger display buffers */
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (16 * 1024)    /**< [bytes] - Reduced from 24KB to save RAM*/
